...
[6월 5일 (수) : 실습 프로젝트 준비 ](#6월-5일-수) <br>
[6월 7일 (금) : 연산자 / 실습 프로젝트 ](#6월-7일-금) <br>
[6월 10일 (월) : 조건문, 반복문, 배열, 레퍼런스, 인스턴스, 가비지, 가비지 컬렉터 / 실습 프로젝트 (배열, 예외 처리) ](#6월-10일-월) <br>
[6월 11일 (화) : print, scanner / 실습 프로젝트 (문자열 비교, 메서드) ](#6월-11일-화) <br>
...
## 6월 17일 (월)
학습 내용이 많아지니 하루에 정리하기가 어렵다.. 주말에 복습하면서 정리하자
